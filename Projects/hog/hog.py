...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for k in range(num_rolls):
        temp = dice()   # its a function, use this way! In this Function, theres 2 Functions.
...
def free_bacon(score):
    ...
    "*** YOUR CODE HERE ***"
    #trans_pi = str(pi)
    #save_trans_pi = trans_pi[:score+1]
    #pi = int(save_trans_pi)

    # 1) ** 2) //
    # output from left to right by // with n dights 
    # score: -1 to correct the position 
    pi = pi // 10 ** (len(str(pi))-score-1)
...
def swine_align(player_score, opponent_score):
    ...
    if player_score == 0 or opponent_score == 0:
        ...
        gcd = find_gcd(player_score, opponent_score)
        if gcd < 10:
            return False
        else:
            return True
...
def announce_lead_changes(last_leader=None):
    ...
    def say(score0, score1):
        ...
        if leader != None and leader != last_leader:
            print('Player', leader, 'takes the lead by', abs(score0 - score1))  # the difference
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        flag = 0
        if not(who):
            temp = score0 - last_score
            if temp > running_high:
                print(temp, 'point(s)! The most yet for Player 0')
                # high score marke, avoid double score count for same value
                flag = 1    
            return announce_highest(who, score0, temp if flag == 1 else running_high)
        else:
            temp = score1 - last_score
            if temp > running_high:
                 print(temp, 'point(s)! The most yet for Player 1')
                 flag = 1
            return announce_highest(who, score1, temp if flag == 1 else running_high)               
...
def make_averaged(original_function, trials_count=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    # original_function: values (dice, obove) -> sum, run n times
    # trials_count: n times 
    # sum = (v1+v2+v3+v4+v1+.....+v4) for n times
    # avg = sum / n 
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    "*** YOUR CODE HERE ***"
    # END PROBLEM 9
    max_val, best_roll = 0, 0
    i = 1
    average_val = make_averaged(roll_dice, trials_count)
    while i <= 10:
        avg = average_val(i, dice)
        if avg > max_val:
            max_val = avg
            best_roll = i
        i += 1
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    # if player 0 rolls 0 then count free bacon too!
    # after this can check the extra turn 
...
def final_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    # score after free bacon
    new_score = score + free_bacon(opponent_score)
    return extra_turn_strategy(new_score, opponent_score, cutoff=6, num_rolls=6)
